...
function Banner() {
  return (
    <section className="w-full justify-center items-center bg-cover bg-center bg-no-repeat mt-0 md:mt-20">
      <div className="w-full px-4 py-6 md:px-5 md:py-8  justify-center items-center">
        <div className="w-full flex relative">
          ...
          <div className="relative z-10 flex flex-col md:flex-row w-full max-w-7xl mx-auto">
            <div className="flex flex-col gap-5 md:gap-7 md:py-30 w-full md:w-[50%] order-2 md:order-1">
            ...
            <div className="flex w-full md:w-[50%] justify-center md:justify-end items-center order-1 md:order-2 py-5 md:py-0">
              <div className="flex justify-center items-center w-[90%] px-5 py-10">
